export class CanvasLocal {
    ...
    */
    ...
    paint() {
        this.drawLine(300, 100, 450, 200);
        this.drawLine(450, 200, 450, 350);
        this.drawLine(450, 350, 300, 450);
        this.drawLine(300, 450, 150, 350);
        this.drawLine(150, 350, 150, 200);
        this.drawLine(150, 200, 300, 100);  
